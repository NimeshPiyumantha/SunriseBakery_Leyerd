...
public class ItemDTO {
    ...
    public ItemDTO(String itemCode, String itemName, String itemDescription, String itemPackSize, double itemUnitPrice, int itemQtyOnHand, String itemAddDate, String itemAddTime) {
        ItemCode = itemCode;
        ItemName = itemName;
