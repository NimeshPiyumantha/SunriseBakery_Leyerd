...
public class CustomDTO {
    ...
    public CustomDTO(String itemCode, String itemName, int itemSoldQty, double itemUnitPrice) {
        ItemCode = itemCode;
        ItemName = itemName;
    ...
    public CustomDTO(String orderDate, int itemSoldQty,int orderCount,  double sumOfTotal) {
        OrderDate = orderDate;
        this.itemSoldQty = itemSoldQty;
