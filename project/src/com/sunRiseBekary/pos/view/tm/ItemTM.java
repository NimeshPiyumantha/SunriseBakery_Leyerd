...
public class ItemTM {
    ...
    public ItemTM(String itemCode, String itemName, String itemDescription, String itemPackSize, double itemUnitPrice, int itemQtyOnHand, String itemAddDate, String itemAddTime) {
        ItemCode = itemCode;
        ItemName = itemName;
