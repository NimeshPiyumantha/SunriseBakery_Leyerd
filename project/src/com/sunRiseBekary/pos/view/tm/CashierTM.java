...
public class CashierTM implements Comparable<CashierTM> {
    ...
    public CashierTM(String cashierID, String cashierName, String cashierPsw, String cashierAddress, String cashierCNumber, String cashierNIC, double cashierSalary, String cashierDescription, String cashierAddDate, String cashierAddTime) {
        CashierID = cashierID;
    ...
    public int compareTo(CashierTM o) {
        return CashierID.compareTo(o.getCashierID());
    }
}
