...
public class CustomEntity {
    ...
    public CustomEntity(String itemCode, String itemName, int itemSoldQty, double itemUnitPrice) {
        ItemCode = itemCode;
        ItemName = itemName;
    ...
    public CustomEntity(String orderDate, int itemSoldQty,int orderCount,  double sumOfTotal) {
        OrderDate = orderDate;
        this.itemSoldQty = itemSoldQty;
